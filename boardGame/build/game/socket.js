	...
	return {
		...
		init : function(){
			...
			if (window.location.protocol == 'http:') {
				this.connect('ws://' + window.location.host + gameURL);
			} else {
				this.connect('wss://' + window.location.host + gameURL);
			}
		...
		socketSend : function(handle, playerNum, extraInfo, alerting)
		{
			var sending = {};
			var message;
			if(alerting){
