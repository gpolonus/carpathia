function Game(context, logHolder, tokenTracker) {
	...
	function Board(num) {
		...
		{
			var start = {x: ctx.canvas.width/2 - 4*spaceWidth + place*spaceWidth*3, y:ctx.canvas.height/2 - spaceWidth};
			if(hovering){
	...
	function Player(num, name, color) {
		...
		this.roll = function()
		{
			...
			var rolling = true;
			var point = {x: ctx.canvas.width/2 - spaceWidth*1.5 + spaceWidth/2, y: ctx.canvas.height/2 - spaceWidth*1.5 + spaceWidth*0.2};
